...
param(
    ...
    [Parameter(Mandatory = $false)]
    [string]$IndexName = "sharepoint-sync-index",
    
    [Parameter(Mandatory = $false)]
    [string]$DataSourceName = "sharepoint-sync-datasource",
    
    [Parameter(Mandatory = $false)]
    [string]$SkillsetName = "sharepoint-sync-skillset",
    
    [Parameter(Mandatory = $false)]
    [string]$IndexerName = "sharepoint-sync-indexer",
    
    # Vector Search Configuration Names
    [Parameter(Mandatory = $false)]
    [string]$VectorSearchProfile = "sharepoint-sync-azureOpenAi-text-profile",
    
    [Parameter(Mandatory = $false)]
    [string]$VectorizerName = "sharepoint-sync-azureOpenAi-text-vectorizer",
    
    [Parameter(Mandatory = $false)]
    [string]$AlgorithmName = "sharepoint-sync-algorithm",
    
    [Parameter(Mandatory = $false)]
    [string]$SemanticConfigName = "sharepoint-sync-semantic-configuration",
